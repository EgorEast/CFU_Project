...
////////////////////////////////////////////////////КЛАСС БАШЕН////////////////////////
//Конструктор класса
Tower::Tower(sf::Image& image, sf::String Name, sf::Vector2f startPos, int Width, int Height, int& moneyBalance)
	...
	if (name == "TowerTwo") {
		sprite.setTextureRect(sf::IntRect(58, 0, width, height));
		_towerPrice = 70;
	}
	if (name == "TowerThree") {
		sprite.setTextureRect(sf::IntRect(117, 0, width, height));
		_towerPrice = 100;
	}
	if (name == "TowerFour") {
		sprite.setTextureRect(sf::IntRect(175, 0, width, height));
		_towerPrice = 150;
	}
...
void Tower::onMouseEvent(sf::Event& event, sf::Vector2f posMouse, sf::RenderWindow& window) {
	control (event, posMouse, window);
	checkCollisionWithMap (event, posMouse, window);
}

//Управление башней
void Tower::control(sf::Event& event, sf::Vector2f posMouse, sf::RenderWindow& window) {
...
void Tower::checkCollisionWithMap(sf::Event& event, sf::Vector2f posMouse, sf::RenderWindow& window) {
