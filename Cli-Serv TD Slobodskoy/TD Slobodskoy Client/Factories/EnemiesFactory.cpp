...
EnemiesFactory::EnemiesFactory(Scene& scene, nlohmann::json& jsonFile) {
	...
	// Инициализирую позицию финиша по x в соответствии с последней точкой
	_posFinish.x = _jsonFile["levelData"]["path"][_points-1][0];
	_posFinish.y = _jsonFile["levelData"]["path"][_points-1][1];	//Инициализирую позицию финиша по y в соответствии с последней точкой
}
